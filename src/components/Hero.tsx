        ...
        <section className="w-full min-h-[70vh] py-20 ">
            <div className="container mx-auto px-4 md:px-6 flex flex-col items-center space-y-4 text-center">
                ...
                <div className="space-x-4">
                    <Link href="/projects">
                        <Button
                            className="inline-flex h-9 items-center justify-center rounded-md bg-primary px-8 py-6 text-md font-medium text-gray-50 shadow transition-colors hover:bg-gray-900/90 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-gray-950 disabled:pointer-events-none disabled:opacity-50 dark:bg-gray-50 dark:text-gray-900 dark:hover:bg-gray-50/90 dark:focus-visible:ring-gray-300"
                        >
                            View Projects
                        </Button>
                    </Link>
                    <Link href="/contact">
                        <Button className="text-primary text-md font-semibold dark:text-gray-200 hover:underline" variant="link">
                            Contact Me
                        </Button>
                    </Link>
                </div>
